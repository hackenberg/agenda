...
public class Assignment {
    ...
    protected int getDate_unix() {
        return date_unix;
    }

    protected void setDate_unix(int date_unix) {
    ...
    protected void setPts(int pts) {
        this.pts = pts;
    }

    protected int getPts_max() {
        return pts_max;
    }

    protected void setPts_max(int pts_max) {
